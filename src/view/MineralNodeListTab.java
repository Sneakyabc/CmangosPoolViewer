...
public class MineralNodeListTab extends JPanel
{
	...
	private JCheckBox chkbxDarkIronDeposit165658;
	...
	public MineralNodeListTab()
	{
		...
		chkbxDarkIronDeposit165658 = new JCheckBox("Dark Iron Deposit (165658)");
		chkbxDarkIronDeposit165658.setSelected(true);
		...
		boxes.add(chkbxDarkIronDeposit165658);
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
									...
									.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
										.addComponent(chkbxDarkIronDeposit165658, GroupLayout.DEFAULT_SIZE, 154, Short.MAX_VALUE)
										.addComponent(chkbxRichThorium175404, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		...
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGap(2)
					.addComponent(chkbxDarkIronDeposit165658)
					.addPreferredGap(ComponentPlacement.UNRELATED)
	...
	private void CreateActionHandlers()
	{
		ActionListener allMineralNodesChkbxAH = new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				chkbxDarkIronDeposit165658.setSelected(chkbxStandardMiningNodes.isSelected());
